...
from backend.agentic.utils.text import count_tokens
...
class MessageItem:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        # Chat APIs (e.g. Mistral via OpenRouter) require `content` on tool
        # messages. Omitting it when empty breaks validation.
        if self.role == "tool":
